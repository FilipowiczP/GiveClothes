    ...
    const handleThird = () =>{
     ...
     return (
        <section className="whoHelp" id="whoHelp">
            ...
            <div className={slider === 1 ? "whoHelp__content" : "whoHelp__content__hide"}>
                <p className="whoHelp__content__text">W naszej bazie znajdziesz listę zweryfikowanych Fundacji, z którymi współpracujemy. Możesz sprawdzić czym się zajmują, komu pomagają i czego potrzebują.</p>
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Fundacja "Dbam o zdrowie"</h2>
                ...
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Fundacja "Dla dzieci"</h2>
                ...
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Fundacja "Bez domu"</h2>
                        <p>Cel i misja: Pomoc dla osób nie posiadających miejsca zamieszkania.</p>
                    </div>
                    <p>ubrania, jedzenie, ciepłe koce</p>
                </div>      
            </div>
            <div className={slider === 2 ? "whoHelp__content" : "whoHelp__content__hide"}>
                <p className="whoHelp__content__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Organizacja "Lorem Ipsum 1"</h2>
                ...
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Organizacja "Lorem Ipsum 2"</h2>
                ...
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Organizacja "Lorem Ipsum 3"</h2>
                        <p>Scelerisque in dictum non consectetur a erat nam.</p>
                    </div>
                    <p>Mi, quis, hendrerit, dolor</p>
                </div>      
            </div>
            <div className={slider === 3 ? "whoHelp__content" : "whoHelp__content__hide"}>
                <p className="whoHelp__content__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Zbiórka "Lorem Ipsum 1"</h2>
                        <p>Quis varius quam quisque id diam vel quam elementum pulvinar.</p>
                    </div>
                    <p>Egestas, sed, tempus</p>
                </div>      
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Zbiórka "Lorem Ipsum 2"</h2>
                        <p>Hendrerit gravida rutrum quisque non tellus orci ac auctor augue.</p>
                    </div>
                    <p>Ut, aliquam, purus, sit, amet</p>
                </div>      
                <div className="whoHelp__content__section">
                    <div>
                        <h2 className="whoHelp__content__section__title">Zbiórka "Lorem Ipsum 3"</h2>
                        <p>Scelerisque in dictum non consectetur a erat nam.</p>
                    </div>
                    <p>Mi, quis, hendrerit, dolor</p>
                </div>      
